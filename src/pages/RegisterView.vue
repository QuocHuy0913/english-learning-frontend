...
async function submit() {
  ...
  try {
    ...
    error.value = 'Failed to register. Email might be taken.';
  }
}
    ...
    <div class="container"
      ...
      <div class="card border-0 shadow-sm rounded-4 p-4 p-md-5 bg-white">
        <div class="text-center mb-4">
          ...
          <h3 class="fw-bold text-success mt-2">Create an Account</h3>
          <p class="text-muted">Join us and start your English learning journey today.</p>
        </div>
        <form @submit.prevent="submit">
          ...
          <button type="submit"
                  class="btn btn-success w-100 rounded-pill fw-semibold py-2">Register</button>
        </form>
